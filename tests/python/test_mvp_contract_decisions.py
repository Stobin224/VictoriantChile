...
EXPECTED_DOCUMENT = {'schema_version': 2,
 ...
 'decisions': [{'id': 'MVP-001-social-tension-sign',
                'topic': 'Social tension sign convention',
                'question': 'Does a higher social_tension value represent worse tension, and which effect direction '
                            'increases or reduces tension?',
                'status': 'approved',
                'resolution': {'target': 'metrics.social_tension',
                               'higher_is_worse': True,
                               'alert_threshold': {'op': '>', 'valueS': 7000},
                               'driver_weight_scale': 'weight_ppm',
                               'drivers': [{'target': 'internals.tension.cost_of_living', 'weight_ppm': 350000},
                               ...
                               'content_alignment': {'content_pack_change_in_pr8': False, 'content_pack_change_pr': 9}},
                'rationale': 'The metric now has one sign convention and exact integer drivers for later loader '
                             'alignment.'},
               {'id': 'MVP-002-cause-category',
                ...
                'status': 'approved',
                'resolution': {'ordered_categories': ['DECISION', 'EVENT', 'REFORM', 'MOVEMENT', 'MODIFIER', 'SYSTEM'],
                               'modifier_parent_categories': ['DECISION', 'EVENT', 'REFORM', 'MOVEMENT'],
                               'system_causes': {'clamp': 'SYSTEM:CLAMP',
                                                 'rounding': 'SYSTEM:ROUNDING',
                                                 'ig_clout_normalize': 'SYSTEM:IG_CLOUT_NORMALIZE'},
                               'allow_additional_categories': False},
                'rationale': 'A closed ordered category set is required for stable causal serialization and '
                             'reporting.'},
               {'id': 'MVP-003-effect-order',
                'topic': 'Effect ordering',
                'question': 'What exact deterministic order applies multiple effects targeting the same value within '
                            'one tick?',
                'status': 'approved',
                'resolution': {'set_handling': {'winner_order': ['priority_desc', 'effect_instance_id_ordinal_asc'],
                ...
                'rationale': 'Deterministic per-target ordering is required for replay, testing, and causal '
                             'explanations.'},
               {'id': 'MVP-004-tick-order',
                ...
                'status': 'approved',
                'resolution': {'phases': ['increment_tick',
                                          'expire_effects',
                ...
                'rationale': 'One canonical phase order prevents hidden feedback loops and makes reports '
                             'reproducible.'},
               {'id': 'MVP-005-rng-contract',
                'topic': 'RNG contract',
                'question': 'What RNG algorithm, seed ownership, draw ordering, and serialized state define '
                            'deterministic randomness?',
                'status': 'approved',
                'resolution': {'algorithm': 'pcg32-xsh-rr',
                               ...
                               'serialized_fields': [{'name': 'state_u64', 'format': 'hex_lowercase_16'},
                                                     {'name': 'stream_u64',
                               ...
                               'sequential_seed_initialization': {'seed_type': 'int64_signed',
                                                                  'seed_encoding': 'twos_complement_little_endian',
                                                                  'preimage': {'domain_tag': 'VictoriantChile/pcg32-v1/init',
                                                                               'separator_byte_hex': '00',
                                                                               'field_order': ['domain_tag_ascii',
                                                                                               'separator_byte',
                                                                                               'seed_i64_le']},
                                                                  'derivation': 'sha-256',
                                                                  'digest_extraction': {'state_u64': {'offset_bytes': [0,
                                                                                                                       7],
                                                                                                      'byte_order': 'little_endian'},
                                                                                        'stream_u64_pre_oddify': {'offset_bytes': [8,
                                                                                                                                   15],
                                                                                                                  'byte_order': 'little_endian'},
                                                                                        'stream_u64_post_process': 'bitwise_or_1'},
                                                                  'draw_count_u64_initial_hex': '0000000000000000'},
                               'draw_transition': {'old_state_source': 'state_u64',
                                                   'new_state_formula': 'old_state * multiplier + stream_u64 modulo '
                                                                        '2^64',
                                                   'xorshifted_formula': 'uint32((((old_state >> 18) xor old_state) >> '
                                                                         '27))',
                               ...
                               'counter_exhaustion': {'when': 'draw_count_u64 == uint64_max before draw',
                                                      'behavior': 'fail_closed_without_state_stream_or_counter_change'},
                               'bounded_draw': {'bound_must_be_positive': True,
                               ...
                               'event_selector_keying': {'enabled': True,
                                                         'encoding': 'utf-8',
                                                         'key_parts': ['seed', 'tick', 'system', 'template', 'slot'],
                                                         'field_types': {'seed': 'int64_signed',
                                                                         'tick': 'uint64',
                                                                         'system': 'ascii_identifier',
                                                                         'template': 'ascii_identifier',
                                                                         'slot': 'uint64'},
                                                         'string_validation': {'pattern': '[a-z0-9][a-z0-9._-]*',
                                                                               'forbid': ['empty',
                                                                                          'whitespace',
                                                                                          'control_chars',
                                                                                          'newlines',
                                                                                          'unicode',
                                                                                          'nul_bytes']},
                                                         'framing': {'domain_tag': 'VictoriantChile/pcg32-v1/event-selector',
                                                                     'separator_byte_hex': '00',
                                                                     ...
                                                                     'field_order': ['domain_tag_ascii',
                                                                                     ...
                                                                                     'slot_u64_le']},
                                                         'derivation': 'sha-256',
                                                         'digest_extraction': {'keyed_state_u64': {'offset_bytes': [0,
                                                                                                                    7],
                                                                                                   'byte_order': 'little_endian'},
                                                                               'keyed_stream_u64_pre_oddify': {'offset_bytes': [8,
                                                                                                                                15],
                                                                                                               'byte_order': 'little_endian'},
                ...
                'rationale': 'A human-approved PR 13 amendment completes pcg32-v1 byte-for-byte without creating '
                             'pcg32-v2.'},
               {'id': 'MVP-006-vertical-slice-duration',
                'topic': 'Vertical-slice duration',
                'question': 'How many turns or simulated months does the MVP vertical slice contain, and what exact '
                            'condition ends it?',
                'status': 'approved',
                'resolution': {'duration_weeks': 26,
               ...
               {'id': 'MVP-007-initial-scenario',
                ...
                'status': 'approved',
                'resolution': {'scenario_id': 'scenario_constitutional_reform_mvp',
                               'start_date': '2030-03-11',
                               'setting': 'fictional_contemporary_chile',
                               'government_profile': 'new_reformist_coalition_government',
                               'legislature_balance': {'lower_chamber': 'narrow_government_majority',
                                                       'upper_chamber': 'government_minority'},
                               'core_metric_defaults': {'metrics.legitimacy': 5500,
                                                        'other_core_metrics_defaultS': 5000},
                               'primary_reform': {'route': 'A', 'kind': 'SPECIAL_CONSTITUTIONAL', 'count': 1},
                               'open_crises_at_tick0': 0,
                               'content_pack_change_in_pr8': False},
                'rationale': 'The MVP now starts from one fixed fictional scenario with one constitutional Route A '
                             'agenda.'},
               {'id': 'MVP-008-primary-objective',
                ...
                'status': 'approved',
                'resolution': {'victory_condition': {'target': 'special_constitutional_route_a_reform',
                                                     'must_be_approved': True,
                                                     'must_be_applied': True,
                                                     'deadline_week_inclusive': 26},
                               'defeat_conditions': [{'type': 'deadline',
                                                      'week': 26,
                                                     ...
                                                     {'type': 'metric_threshold',
                                                      ...
                                                      'op': '<',
                                                      'valueS': 2000},
                                                     {'type': 'blocking_crisis_expiry', 'state': 'unresolved_expired'}],
                               'out_of_slice': ['presidential_election',
                                                'opposition_neutralization',
                                                'full_constituent_route_b',
                                                'four_year_campaign']},
                'rationale': 'Victory and defeat are now tied to one Route A constitutional slice with explicit '
                             'terminal conditions.'},
               {'id': 'MVP-009-cadre-schema-and-roles',
                ...
                'rationale': 'Cadres now have a minimal frozen schema, fixed roles, and a clear static-versus-save '
                             'boundary.'},
               {'id': 'MVP-010-turn-report-top-n',
                'topic': 'Turn-report causal limit',
                'question': 'How many causal contributors appear in each turn report, and how are ties ordered '
                            'deterministically?',
                'status': 'approved',
                'resolution': {'visible_targets': {'max_count': 10,
                                                   'filter': 'delta_totalS != 0',
                                                   'order': ['abs(delta_totalS)_desc', 'target_path_ordinal_asc']},
                               'causes_per_target': {'max_count': 3,
                                                     'order': ['abs(delta_totalS)_desc', 'CauseKey_ordinal_asc']},
                               'other_deltaS': 'exact_remainder',
                               'alerts': {'separate_section': True, 'consume_top_slots': False},
                               'zero_fill': False},
                'rationale': 'The turn report now has fixed limits, deterministic tie-breaks, and exact remainder '
                             'accounting.'},
               {'id': 'MVP-011-active-movements',
                ...
                'status': 'approved',
                'resolution': {'direction_scope': 'scenario_state',
                               'active_movements': [{'theme': 'trabajo/costo de vida',
                                                    ...
                                                    {'theme': 'regional',
                                                     ...
                                                     'initial_direction': 1,
                                                     'last_addressed_tick': 0}],
                               'disabled_movements': [{'movement_id': 'mov_educacion_paros',
                                                       'enabled': False,
                               ...
                               'environmental_representation': {'interest_group_id': 'ig_ambiental_regionalista',
                                                                'movement_id': None,
                                                                'representation_level': 'interest_group_only'},
                               'direction_semantics': 'favorable_to_own_demand',
                               'escalation_rules': {'base_increment': {'condition': 'tick - last_addressed_tick >= 4',
                                                                       'deltaS': 100},
                                                    'high_tension_bonus': {'condition': 'metrics.social_tension > 7000',
                                                                           'deltaS': 100},
                                                    'post_update_clamp': {'minS': 0, 'maxS': 10000},
                                                    'alert_threshold': {'op': '>', 'valueS': 7000},
                                                    'blocking_crisis_eligibility_threshold': {'op': '>',
                                                                                              'valueS': 8500},
                                                    'matching_address_action': 'last_addressed_tick = current_tick'},
                               'disabled_movements_activate_dynamically': False},
                'rationale': 'The slice now has four active movements, five fully disabled movements, and exact '
                             'escalation state rules.'},
               {'id': 'MVP-012-national-aggregation',
                'topic': 'National aggregation contract',
                'question': 'What exact fixed-point, phase, snapshot, cap, rounding, and causal-allocation rules '
                            'define national aggregation?',
                'status': 'approved',
                'resolution': {'numeric_domain': {'scale': 100,
                                                  'S': 100,
                                                  'midS': 5000,
                                                  'minS': 0,
                                                  'maxS': 10000,
                               ...
                               'phase_dispatch': {'internal_reversion_phase': 6,
                                                  ...
                                                  'phase_8_order': [{'pass': 'METRIC_AGGREGATION',
                                                                     'metrics_count': 9,
                                                                     'note': 'nine primary metrics'},
                                                                    {'pass': 'METRIC_AGGREGATION',
                                                                     'metrics_count': 1,
                                                                     'metric': 'metrics.legitimacy',
                                                                     'note': 'legitimacy after derived reads '
                                                                             'pre-aggregation metrics'}]},
                               'pass_execution_semantics': {'input_snapshot': 'immutable_snapshot_at_pass_start',
                                                            ...
                                                            'fail_closed_triggers': ['missing_target',
                                                                                     ...
                                                                                     'ledger_rejection'],
                                                            'fail_closed_guarantees': ['zero_partial_state',
                                                                                       'zero_partial_internals',
                                                                                       'zero_partial_metrics',
                                                                                       'zero_partial_causal_contributions']},
                               'reversion_formula': {'distanceS': 'midS - currentS',
                                                     'reversion_deltaS': 'RoundHalfAwayFromZero(distanceS * alpha_ppm '
                                                                         '/ 1000000)',
                                                     'pre_clampS': 'currentS + reversion_deltaS',
                                                     'finalS': 'clamp(pre_clampS, TargetConfig.minS, '
                                                               'TargetConfig.maxS)',
                                                     'order': ['subtract_current_from_midpoint',
                                                     ...
                                                     'skip_targets': ['internals.legitimacy.performance',
                                                                      'internals.legitimacy.social_tension_load']},
                               'derived_formulas': {'internals.legitimacy.performance': {'op': 'SET',
                                                                                         'expression': 'AVG(metrics.economy, '
                                                                                                       'metrics.security, '
                                                    ...
                                                    'internals.legitimacy.social_tension_load': {'op': 'SET',
                                                                                                 'expression': 'COPY(metrics.social_tension)',
                                                                                                 'reads': 'pre_aggregation_metrics_current_tick'},
                                                    'legitimacy_latency_note': 'legitimacy aggregation in phase 8 sees '
                                                                               'pre-aggregation economy, security, '
                                                                               'governability, social_tension; '
                                                                               'legitimacy has one-tick latency for '
                                                                               'structural changes from aggregation of '
                                                                               'those metrics in same tick'},
                               'metric_aggregation_formula': {'weighted_offset_numerator': 'SUM(weight_ppm[i] * '
                                                                                           '(componentS[i] - midS))',
                                                              'weighted_offsetS': 'RoundHalfAwayFromZero(weighted_offset_numerator '
                                                                                  '/ 1000000)',
                                                              'target_unclampedS': 'midS + weighted_offsetS',
                                                              'targetS': 'clamp(target_unclampedS, TargetConfig.minS, '
                                                                         'TargetConfig.maxS)',
                                                              'elastic_distance': 'targetS - current_metricS',
                                                              'elastic_numerator': 'elastic_distance * alpha_ppm',
                                                              'elastic_deltaS': 'RoundHalfAwayFromZero(elastic_numerator '
                                                                                '/ 1000000)',
                                                              'capped_deltaS': 'clamp(elastic_deltaS, -cap_per_weekS, '
                                                                               '+cap_per_weekS)',
                                                              'pre_finalS': 'current_metricS + capped_deltaS',
                                                              'final_metricS': 'clamp(pre_finalS, TargetConfig.minS, '
                                                                               'TargetConfig.maxS)',
                                                              'delta_totalS': 'final_metricS - current_metricS',
                                                              'pipeline_order': ['sum_weighted_offsets',
                                                                                 ...
                                                                                 'final_clamp'],
                                                              'forbidden': ['swap_cap_and_rounding',
                                                                            'apply_cap_to_weighted_target_instead_of_delta']},
                               'causal_algorithm': {'name': 'ordered_prefix_counterfactual_marginal_v1',
                                                    'description': 'For each metric define F(vector) as the full '
                                                                   'aggregation pipeline returning final_metricS',
                                                    ...
                                                    'telescopic_identity': 'F(Vn) - current_metricS == base_deltaS + '
                                                                           'SUM(component_deltaS)',
                                                    'component_order': 'exact_config_order',
                                                    'zero_contributions_omitted_from_ledger': True,
                                                    'forbidden_methods': ['proportional_split',
                                                                          'largest_remainder',
                                                                          'shapley',
                                                                          'dictionary_order',
                                                                          'invented_residual_to_balance'],
                                                    'no_additional_system_causes': 'SYSTEM:ROUNDING and SYSTEM:CLAMP '
                                                                                   'reserved for other systems; do not '
                                                                                   'emit within aggregation marginal '
                                                                                   'attribution'},
                               'cause_key_grammar': {'format': "CATEGORY + ':' + ID",
                                                     'id_forbidden_chars': [':',
                                                                            '|',
                                                                            'whitespace',
                                                                            'control_chars',
                                                     ...
                                                     'examples': ['SYSTEM:AGG.metrics.economy',
                                                     ...
                                                     'forbidden_ambiguous_forms': ['SYSTEM:AGG:metrics.economy',
                                                                                   'SYSTEM:AGG:metrics.economy:internals.economy.growth']},
                               'cause_prefix_materialization': {'source_format': 'CATEGORY:BASE_ID',
                                                                'separator_count': 1,
                                                                ...
                                                                'materializations': {'aggregation_base': {'cause_prefix': 'SYSTEM:AGG',
                                                                                                          'metric': 'metrics.economy',
                                                                                                          'expected_cause_ref': {'category': 'CauseCategory.System',
                                                                                                                                 'id': 'AGG.metrics.economy'},
                                                                                                          'canonical_key': 'SYSTEM:AGG.metrics.economy'},
                                                                                     'aggregation_component': {'cause_prefix': 'SYSTEM:AGG',
                                                                                                               'metric': 'metrics.economy',
                                                                                     ...
                                                                                     'reversion': {'cause_prefix': 'SYSTEM:REVERSION',
                                                                                     ...
                                                                                     'derived': {'cause_prefix': 'SYSTEM:DERIVED',
                                                                ...
                                                                'must_fail_prefixes': ['AGG',
                                                                                       ...
                                                                                       'system:AGG',
                                                                                       'SYSTEM:AGG.']},
                               'hidden_internal_policy': {'internals_remain_hidden': True,
                                                          ...
                                                          'provenance_clarifications': {'reversion_labels': 'ephemeral_plan_provenance_no_serialization',
                               ...
                               'vectors': {'reversion_6000_to_5974': {'currentS': 6000,
                                                                      'midS': 5000,
                                                                      'alpha_ppm': 26307,
                                                                      'distanceS': -1000,
                                                                      'rounded_deltaS': -26,
                                                                      'finalS': 5974},
                                           'economy': {'current_metricS': 5000,
                                                       'components': [{'target': 'internals.economy.growth',
                                                                       'componentS': 6000,
                                                                       'weight_ppm': 350000},
                                                       ...
                                                       'finalS': 5062,
                                                       'delta_totalS': 62},
                                           'social_tension': {'current_metricS': 5000,
                                                              'components': [{'target': 'internals.tension.cost_of_living',
                                                                              'componentS': 6000,
                                                                              'weight_ppm': 350000},
                                           ...
                                           'cap_weekly': {'currentS': 5000,
                                                          ...
                                                          'capped_deltaS': 600,
                                                          'finalS': 5600},
                                           'rounding_half_away_from_zero': [{'numerator': 500000,
                                                                             'denominator': 1000000,
                                                                             'result': 1},
                                                                            {'numerator': -500000,
                                                                             'denominator': 1000000,
                                                                             'result': -1}]},
                               'causal_vectors': {'economy_prefix_deltas': {'F(V0)': 5000,
                                                                            'F(V1)': 5029,
                                                                            'F(V2)': 5050,
                                                                            'F(V3)': 5050,
                                                                            'F(V4)': 5062,
                                                                            'base_deltaS': 0,
                                                                            'component_deltas': [{'component': 'internals.economy.growth',
                                                                                                  'deltaS': 29},
                                                                            ...
                                                                            'telescopic_check': '62 == 0 + 29 + 21 + 0 '
                                                                                                '+ 12'},
                                                  'social_tension_prefix_deltas': {'F(V0)': 5000,
                                                                                   'F(V1)': 5056,
                                                                                   'F(V2)': 5095,
                                                                                   'F(V3)': 5056,
                                                                                   'F(V4)': 5032,
                                                                                   'base_deltaS': 0,
                                                                                   'component_deltas': [{'component': 'internals.tension.cost_of_living',
                                                                                                         'deltaS': 56},
                                                                                   ...
                                                                                   'telescopic_check': '32 == 0 + 56 + '
                                                                                                       '39 + (-39) + '
                                                                                                       '(-24)'}}},
                'rationale': 'National aggregation now has one fixed-point execution order, one pre-aggregation '
                             'derived snapshot, one exact telescoping causal allocation, pass-execution semantics for '
                             'atomic snapshots and fail-closed guarantees, materialization rules for cause_prefix, and '
                             'ephemeral provenance scope for hidden internals.'}]}
